      ...
      >
        ...
        <div className="panel" style={{ padding: '2rem', background: 'rgba(255,255,255,0.02)' }}>
          ...
          <button
            ...
            onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor = `${b.accent}`; (e.currentTarget as HTMLElement).style.background = 'rgba(255,255,255,0.08)'; }}
            onMouseLeave={e => { (e.currentTarget as HTMLElement).style.borderColor = 'var(--border-light)'; (e.currentTarget as HTMLElement).style.background = 'rgba(255,255,255,0.05)'; }}
          >
