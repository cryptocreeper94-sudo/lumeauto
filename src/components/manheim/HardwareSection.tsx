      ...
      <div className="container" style={{ maxWidth: '1100px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2.5rem' }}>
          ...
          <motion.div {...f} style={{ display: 'flex', flexDirection: 'column' }}>
            <img src="/assets/images/phase1.png" style={{ width: '100%', height: '220px', objectFit: 'cover', borderRadius: '16px', marginBottom: '1.5rem', border: '1px solid var(--border-light)' }} alt="Standard OBD-II Dongle" />
