      ...
      <div className="container" style={{ maxWidth: '1100px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '1.25rem' }}>
          {[
            ...
            { icon: <Lock size={18}/>, title: 'Enterprise Trust Chain (PoA)', items: ['Layer 1 Proof-of-Authority blockchain', 'Deterministic consensus — no mining, no gas fees', 'Each facility operates as a validator node', 'Condition certificates anchored immutably on-chain', 'Cryptographic replay verification for arbitration', 'Purpose-built for closed-loop enterprise networks'], color: '#a78bfa' },
            ...
            <motion.div key={i} {...f} transition={{ delay: i * 0.05 }} className="panel" style={{ padding: '1.5rem' }}>
