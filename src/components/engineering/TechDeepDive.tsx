      ...
      <div className="container" style={{ maxWidth: '1100px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '1.25rem' }}>
          {[
            ...
            { icon: <Radio size={18}/>, title: 'Voice Intelligence (Optional)', items: ['LLM-agnostic bidirectional voice engine', '15+ hands-free commands', 'Speech pattern learning per driver', 'Noise cancellation for lot environments', 'Wake word activation', 'Contextual command disambiguation'], color: '#a78bfa' },
