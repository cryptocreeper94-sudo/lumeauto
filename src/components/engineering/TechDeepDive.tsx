      ...
      <div className="container" style={{ maxWidth: '1100px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '1.25rem' }}>
          {[
            ...
            { icon: <FileCode size={18}/>, title: 'TrustShield Security Layer', items: ['AI agent certification framework', 'Deterministic output attestation', 'Cryptographic trust chain verification', 'Zero-trust architecture enforcement', 'Cross-system integrity validation', 'Reference: trustshield.tech'], color: '#a78bfa' },
          ].map((sys, i) => (
